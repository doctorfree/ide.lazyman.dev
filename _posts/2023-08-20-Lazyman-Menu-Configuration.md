---
title: LazyIde Menu Configuration
author: doctorfree
date: 2023-08-20 16:20:00 +0800
tags: [neovim, menu, config, configuration, initialization]
pin: true
img_path: "/posts/20230820"
---

<h1 align="center">LazyIde Menu Configuration</h1>

<div align="center">
<p float="left">
  <img
    src="https://raw.githubusercontent.com/wiki/doctorfree/nvim-lazyman/screenshots/lazyide.png"
    alt="LazyIde Configuration Menu"
...
The [lazyman](https://lazyman.dev) menu system includes support for menu-driven
configuration of several Neoovim configurations. Currently supported menu
management of Neovim configurations include:
...
#!/usr/bin/env bash
#
# lzyide_config - configure the LazyIde Neovim configurations
#
